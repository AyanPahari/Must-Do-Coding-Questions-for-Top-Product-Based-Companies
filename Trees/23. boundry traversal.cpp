...
public:
    ...
    vector<int> printBoundary(Node *root)
    {
        ...
        if (!root->left && !root->right)
            return res; //otherwise root node will be counted twice,
        //leaf node function will also categorize root node as a leaf node
